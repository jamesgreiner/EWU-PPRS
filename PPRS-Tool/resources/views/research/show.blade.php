...
<html>
    ...
    <div class="header">
        ...
        <div class="border-t border-gray-200">
            ...
            @if($x < 1)
            @if( $file->study_id== $entry->study_id )
            @php($x=1)
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">
                Data Description
            ...
            <a href="{{ route('research.index') }}" class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">Back to list</a>
        </div>
        </div>
