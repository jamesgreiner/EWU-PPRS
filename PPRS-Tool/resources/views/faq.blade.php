...
<html>
    ...
    <body>
        @section('content')
            ...
            <!-- question and answer -->
            <div class="div-2"><div class="faq-head">What is the Palouse Prairie Restoration Project?</div></div>
            ...
            <!-- question and answer -->
            <div class="faq-divider"></div>
            <div class="div-2"><div class="faq-head">Who can I get in touch with to inquire about the project?</div></div>
            <div class="faq-divider"></div>
            <p class="faq-body">
            ...
            <!-- question and answer -->
            <div class="faq-divider"></div>
            <div class="div-2"><div class="faq-head">How do I make changes to data that was submitted for a research project?</div></div>
            <div class="faq-divider"></div>
            <p class="faq-body">
            ...
            <!-- question and answer -->
            <div class="faq-divider"></div>
            <div class="div-2"><div class="faq-head">How do I delete data that was submitted for a research project?</div></div>
            <div class="faq-divider"></div>
            <div class="content">
                <p class="faq-body">
            ...
            <!-- question and answer -->
            <div class="faq-divider"></div>
            <div class="div-2"><div class="faq-head">How do I change my password?</div></div>
            <div class="faq-divider"></div>
            <p class="faq-body">
            ...
            <!-- question and answer -->
            <div class="faq-divider"></div>
            <div class="div-2"><div class="faq-head">Who should I contact if I'm running into problems with any part of the management tool?</div></div>
            <div class="faq-divider"></div>
            <p class="faq-body">
